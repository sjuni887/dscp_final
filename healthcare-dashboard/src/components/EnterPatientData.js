...
const EnterPatientData = () => {
  ...
  const handleAddPatient = async () => {
    try {
      await axios.post('http://127.0.0.1:5000/patients', formData);
      fetchPatients();
      setFormData({
        IndexNo: '',
        Age: 17,
  ...
  const handleEditPatient = (index) => {
    setEditFormData(patients[index]);
  ...
  const handleEditSave = async () => {
    try {
      await axios.put(`http://127.0.0.1:5000/patients/${editFormData.IndexNo}`, editFormData);
      fetchPatients();
      setIsEditModalOpen(false);
    } catch (error) {
      console.error("There was an error editing the patient!", error);
    }
  };
    ...
    <div className="enter-patient-data-container">
      ...
      <form className="patient-form">
        <div className="grid-container">
          ...
          <div className="grid-item">
            <fieldset>
              <legend>Kidney Related Features</legend>
          ...
          <div className="grid-item">
            <fieldset>
              <legend>Anemia Related Features</legend>
          ...
          <div className="grid-item">
            <fieldset>
              <legend>Transfusion Related Features</legend>
          ...
          <div className="grid-item">
            <fieldset>
              <legend>Surgical and Postoperative Features</legend>
              <label>Intraop:</label>
        ...
        <tbody>
          {patients.map((patient, index) => (
            <tr key={index}>
              ...
              <td>
                <button onClick={() => handleEditPatient(index)}>Edit</button>
              </td>
            </tr>
          ))}
        </tbody>
